...
import TestPanel from "./modules/test/TestPanel"
import TestPanelCloud from "./modules/test/TestPanelCloud"
...
export default class GameConfig{
    ...
    static init(){
        ...
        reg("modules/test/TestPanel.ts",TestPanel);
        reg("modules/test/TestPanelCloud.ts",TestPanelCloud);
