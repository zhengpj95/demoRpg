...
import HtmlLabel from "./script/HtmlLabel"
import ScrollLabel from "./script/ScrollLabel"
...
export default class GameConfig{
    ...
    static init(){
        ...
        reg("script/HtmlLabel.ts",HtmlLabel);
        reg("script/ScrollLabel.ts",ScrollLabel);
